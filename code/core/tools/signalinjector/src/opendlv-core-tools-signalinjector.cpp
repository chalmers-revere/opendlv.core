...
//#include "opendlvdata/GeneratedHeaders_ODVDopendlvdata.h" 
 // removing the opendlv/GeneratedHeaders_opendlvdata.h as it doesn't exist 
...
void Signalinjector::setUp()
{
  ...
  std::string path = "/opt/opendlv.data/Testcase/" + std::to_string(m_testNumber) + "/";
