...
ProxyBeacons::ProxyBeacons(const int &argc, char **argv)
    : DataTriggeredConferenceClientModule(argc, argv, "proxy-beacons")
    , m_angle(0.0f)
    , m_R(0)
    , m_G(255)
    , m_B(0) {}

ProxyBeacons::~ProxyBeacons() {}

void ProxyBeacons::setUp() {}

void ProxyBeacons::tearDown() {}

void ProxyBeacons::nextContainer(odcore::data::Container &c) {
...
odcore::data::dmcp::ModuleExitCodeMessage::ModuleExitCode ProxyBeacons::body() {
