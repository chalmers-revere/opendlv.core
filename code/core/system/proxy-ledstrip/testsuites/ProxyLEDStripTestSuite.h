...
#ifndef PROXY_PROXYLEDSTRIP_TESTSUITE_H
#define PROXY_PROXYLEDSTRIP_TESTSUITE_H

#include "cxxtest/TestSuite.h"

// Include local header files.
#include "../include/ProxyLEDStrip.h"
 ...
 */
class ProxyTestling : public ProxyLEDStrip {
   private:
    ProxyTestling();

   public:
    ProxyTestling(const int32_t &argc, char **argv)
        : ProxyLEDStrip(argc, argv) {}

    // Here, you need to add all methods which are protected in ProxyLEDStrip and which are needed for the test cases.
};

/**
 * The actual testsuite starts here.
 */
class ProxyLEDStripTest : public CxxTest::TestSuite {
   private:
    ProxyTestling *dt;
   ...
   private:
     ...
     */
    ProxyLEDStripTest(const ProxyLEDStripTest & /*obj*/);
     ...
     */
    ProxyLEDStripTest &operator=(const ProxyLEDStripTest & /*obj*/);
};

#endif /*PROXY_PROXYLEDSTRIP_TESTSUITE_H*/
