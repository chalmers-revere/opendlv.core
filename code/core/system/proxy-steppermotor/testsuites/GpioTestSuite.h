...
#ifndef STEPPERMOTOR_TESTSUITE_H
#define STEPPERMOTOR_TESTSUITE_H
 ...
 */
class ProxyTestling : public steppermotor {
   private:
    ProxyTestling();

   public:
    ProxyTestling(const int32_t &argc, char **argv)
        : steppermotor(argc, argv) {}

    // Here, you need to add all methods which are protected in steppermotor and which are needed for the test cases.
};

/**
 * The actual testsuite starts here.
 */
class SteppermotorTest : public CxxTest::TestSuite {
 private:
  ProxyTestling *dt;
 ...
 public:
  void setUp() {
    ...
    string argv0("proxy-steppermotor");
 ...
 private:
   ...
   */
  SteppermotorTest(const GpioTest & /*obj*/);
   ...
   */
  SteppermotorTest &operator=(const SteppermotorTest & /*obj*/);
};
