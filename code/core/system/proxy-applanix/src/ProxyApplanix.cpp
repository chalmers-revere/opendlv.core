...
namespace proxy {
    ...
    void ProxyApplanix::parseAdditionalCommandLineParameters(const int &argc, char **argv) {
    ...
    vector<uint32_t> ProxyApplanix::getListOfNumbers(const string &s) {
    ...
    int32_t ProxyApplanix::run(const int32_t &argc, char **argv) {
